                ...
                Item {
                    ...
                    Row {
                        ...
                        TextInput {
                            ...
                            Keys.onLeftPressed: {
                                if (appLauncher.isHexMode) {
                                    if (hexListView.currentIndex > 0) {
                                        hexListView.currentIndex--;
                            ...
                            Keys.onRightPressed: {
                                if (appLauncher.isHexMode) {
                                    if (hexListView.currentIndex < hexListView.count - 1) {
                                        hexListView.currentIndex++;
                                        hexListView._selectedCol = hexListView.currentIndex;
                                    }
                                } else {
                            ...
                            Keys.onUpPressed: {
                                if (appLauncher.isHexMode && hexListView._selectedRow > 0)
                                    hexListView._selectedRow--;
                            ...
                            Keys.onDownPressed: {
                                if (appLauncher.isHexMode) {
                                    ...
                                    if (hexListView._selectedRow < maxRow)
                                        hexListView._selectedRow++;
