...
Item {
    ...
    Column {
        ...
        Row {
            ...
            Repeater {
                ...
                FilterButton {
                    ...
                    onClicked: {
                        browser.swService.sorting = modelData.key;
                        browser.swService.search(1);
                    }
                }
            ...
            FilterDropdown {
                ...
                onSelected: function(key) {
                    browser.swService.trendDays = parseInt(key);
                    browser.swService.search(1);
                }
            }
        ...
        Row {
            ...
            FilterDropdown {
                ...
                displayValue: {
                    if (!browser.swService || browser.swService.requiredType === "")
                        return "All Types";
                ...
                onSelected: function(key) {
                    browser.swService.requiredType = key;
                    browser.swService.search(1);
                }
            }
            ...
            FilterButton {
                ...
                onClicked: {
                    browser.swService.nsfwEnabled = false;
                    browser.swService.search(1);
                }
            }
            ...
            FilterButton {
                ...
                hasActiveColor: true
                onClicked: {
                    browser.swService.nsfwEnabled = true;
                    browser.swService.search(1);
                }
            }
            ...
            FilterDropdown {
                ...
                displayValue: {
                    if (!browser.swService || browser.swService.requiredResolution === "")
                        return "Any";
                ...
                onSelected: function(key) {
                    browser.swService.requiredResolution = key;
                    browser.swService.search(1);
                }
            }
            ...
            FilterDropdown {
                ...
                displayValue: {
                    if (!browser.swService || browser.swService.requiredTag === "")
                        return "All";
                ...
                onSelected: function(key) {
                    browser.swService.requiredTag = key;
                    browser.swService.search(1);
                }
            }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                property real _realProgress: browser.swService && browser.swService.activeDownloadId ? (browser.swService.downloadProgress[browser.swService.activeDownloadId] || 0) : 0
            ...
            Row {
                ...
                Rectangle {
                    visible: browser.swService && browser.swService.authPaused
                    width: retryText.implicitWidth + 16
                    height: 20
                    radius: 3
    ...
    Connections {
        function onResultsUpdated() {
            ...
            if (toAdd > 0) {
                var batch = [];
                for (var i = 0; i < toAdd; i++) batch.push({
                    "idx": resultsModel.count + i
                })
    ...
    GridView {
        ...
        onContentYChanged: {
            ...
            if (contentY > _prevContentY)
                _lastScrollDir = 1;
            else if (contentY < _prevContentY)
                _lastScrollDir = -1;
                ...
                Rectangle {
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                ActionButton {
                                    ...
                                    onClicked: {
                                        if (thumbDelegate.dlStatus === "done" || thumbDelegate.isLocal || !thumbDelegate.wp)
                                            return ;
                    ...
                    Row {
                        ...
                        Repeater {
                            ...
                            Rectangle {
                                width: tagBadge.implicitWidth + 6
                                height: 14
                                radius: 3
    ...
    Item {
        ...
        Text {
            ...
            RotationAnimation on rotation {
                from: 0
                to: 360
                duration: Style.animSpin
                loops: Animation.Infinite
                running: browser.swService && browser.swService.loading
            }
    ...
    Rectangle {
        ...
        Image {
            ...
            scale: browser._previewOpen ? 1 : 0.85
            opacity: browser._previewOpen ? 1 : 0
        ...
        Rectangle {
            ...
            StyledToolTip {
                visible: previewCloseMouse.containsMouse
                text: "Close preview"
                delay: 400
            }
            ...
            Row {
                ...
                Row {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            width: pvTagText.implicitWidth + 12
                            height: 24
                            radius: 4
                            anchors.verticalCenter: parent.verticalCenter
                ...
                Row {
                    property string _dlSt: {
                        if (!browser.swService || !browser._previewWp)
                            return "";
                    ...
                    ActionButton {
                        ...
                        tooltip: "Download via steamcmd"
                        onClicked: {
                            if (parent._dlSt === "done" || parent._isLocal || parent._dlSt === "downloading" || parent._dlSt === "queued" || !browser._previewWp)
                                return ;
