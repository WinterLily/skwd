...
Item {
    ...
    opacity: _fadeZone > 0 ? Math.min(Math.min(1, Math.max(0, _center / _fadeZone)), Math.min(1, Math.max(0, ((_listView ? _listView.width : 0) - _center) / _fadeZone))) : 1
    ...
    Item {
        ...
        Shape {
            ...
            ShapePath {
                ...
                PathLine {
                    x: delegateItem._topRight
                    y: 0
                }

                PathLine {
                    x: delegateItem._botRight
                    y: delegateItem.height
                }

                PathLine {
                    x: delegateItem._botLeft
                    y: delegateItem.height
                }

                PathLine {
                    x: delegateItem._topLeft
                    y: 0
                }
    ...
    Item {
        ...
        Item {
            ...
            Rectangle {
                ...
                x: delegateItem.skewOffset >= 0 ? parent.width - width - 10 : 10
                width: 22
                height: 22
                radius: 11
            ...
            Item {
                ...
                height: 16
                z: 10
                x: onRight ? parent.width - width - delegateItem._skAbs - 8 : delegateItem._skAbs + 8
                ...
                Column {
                        ...
                        Item {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    delegateItem.service.toggleFavourite(model.name, model.weId || "");
                                }
                            }
                    ...
                    Item {
                        ...
                        TextInput {
                            ...
                            onTextChanged: {
                                ...
                                if (changed)
                                    delegateItem.service.setWallpaperTags(backTagsSection.wpName, backTagsSection.wpWeId, wpTags);
                    ...
                    Item {
                        ...
                        property var currentTags: {
                            ...
                            var key = backTagsSection.wpWeId ? backTagsSection.wpWeId : ImageService.thumbKey(backTagsSection.wpThumb, backTagsSection.wpName);
                            return db[key] || [];
                        }
                    ...
                    Row {
                        ...
                        ActionButton {
                            ...
                            skew: Math.abs(delegateItem.skewOffset) * 0.4
                            onClicked: {
                                delegateItem.service.openSteamPage(model.weId || "");
                                delegateItem.flipped = false;
                            }
                        }
    ...
    containmentMask: Item {
        ...
        function contains(point) {
            ...
            var t = point.y / h;
            var leftX = delegateItem._topLeft * (1 - t) + delegateItem._botLeft * t;
            var rightX = delegateItem._topRight * (1 - t) + delegateItem._botRight * t;
