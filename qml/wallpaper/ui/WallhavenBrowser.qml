        ...
        Row {
            ...
            Repeater {
                ...
                FilterButton {
                    ...
                    onClicked: {
                        browser.whService.sorting = modelData.key;
                        browser.whService.search(1);
                    }
                }
            ...
            FilterDropdown {
                ...
                onSelected: function(key) {
                    browser.whService.topRange = key;
                    browser.whService.search(1);
                }
            }
        ...
        Row {
            ...
            Repeater {
                ...
                FilterButton {
                    ...
                    activeColor: "#e53935"
                    hasActiveColor: modelData.bit === 2
                    activeOpacity: modelData.bit === 2 && (!browser.whService || !browser.whService.apiKey) && !isActive ? 0.4 : 1
            ...
            FilterDropdown {
                ...
                displayValue: {
                    if (!browser.whService || browser.whService.atleast === "")
                        return "Any";
            ...
            FilterDropdown {
                ...
                displayValue: {
                    if (!browser.whService || browser.whService.ratios === "")
                        return "Any";
            ...
            Rectangle {
                ...
                Rectangle {
                        ...
                        Column {
                            ...
                            Row {
                                ...
                                ActionButton {
                                    ...
                                    onClicked: {
                                        if (!thumbDelegate.wp || thumbDelegate.dlStatus === "downloading")
                                            return ;
                    ...
                    Row {
                        ...
                        Rectangle {
                            width: catBadge.implicitWidth + 6
                            height: 14
                            radius: 3
    ...
    Item {
        ...
        Text {
            ...
            RotationAnimation on rotation {
                ...
                duration: Style.animSpin
                loops: Animation.Infinite
                running: browser.whService && browser.whService.loading
            }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Row {
                ...
                Rectangle {
                    width: purText.implicitWidth + 12
                    height: 24
                    radius: 4
                    anchors.verticalCenter: parent.verticalCenter
                    color: {
                        var p = browser._previewWp ? browser._previewWp.purity : "";
                        return p === "sfw" ? Qt.rgba(0.3, 0.8, 0.3, 0.2) : p === "sketchy" ? Qt.rgba(1, 0.8, 0, 0.2) : Qt.rgba(1, 0.3, 0.3, 0.2);
                    }
                ...
                Row {
                    property string _dlSt: {
                        if (!browser.whService || !browser._previewWp)
                            return "";
                    ...
                    ActionButton {
                        ...
                        onClicked: {
                            if (parent._dlSt === "done" || parent._isLocal || parent._dlSt === "downloading" || !browser._previewWp)
                                return ;
                    ...
                    ActionButton {
                        ...
                        onClicked: {
                            if (!browser._previewWp || parent._dlSt === "downloading")
                                return ;
