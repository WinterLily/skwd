            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        anchors.margins: 4
                        width: _typeBadge.implicitWidth + 6
                        height: 14
                        radius: 3
                    ...
                    Column {
                        ...
                        Item {
                            ...
                            TextInput {
                                ...
                                clip: true
                                onTextChanged: {
                                    if (_syncing || !_gridOverlay.overlayData)
                                        return ;
                            ...
                            MouseArea {
                                ...
                                z: -1
                                onClicked: _gridTagField.forceActiveFocus()
                            }
